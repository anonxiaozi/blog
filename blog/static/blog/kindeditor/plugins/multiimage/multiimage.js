...
SWFUpload.prototype.getFlashVars = function () {
	// Build a string from the background param object
...
SWFUpload.prototype.callFlash = function (functionName, argumentArray) {
	...
	// Unescape file background param values
...
// Public: addPostParam adds background name/value pair.  Each name can have only one value.
SWFUpload.prototype.addPostParam = function (name, value) {
	this.settings.post_params[name] = value;
	this.callFlash("SetPostParams", [this.settings.post_params]);
};

// Public: removePostParam deletes background name/value pair.
